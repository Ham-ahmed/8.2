...
echo -e "${CYAN}"
echo "##################################################"
echo "#    GlobalTranslateUltra Installation Script    #"
echo "#                 Version 8.2.5                  #"
echo "##################################################"
echo -e "${NC}"
sleep 2s
...
# Settings
plugin=GlobalTranslateUltra
version=8.2.5
url=https://raw.githubusercontent.com/Ham-ahmed/8.2/refs/heads/main/GlobalTranslate_Ultra-8.2.5.tar.gz
